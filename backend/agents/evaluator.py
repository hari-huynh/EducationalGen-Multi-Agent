...
from agents.pydantic_models.evaluator import EvaluationInput, EvaluationOutput

llm = GroqModel(
    'llama-3.3-70b-versatile',
    provider=GroqProvider(api_key='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')
)
